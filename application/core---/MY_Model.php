...
// get data with paging
    ...
    public function send_email($mail_info) {
        ...
        $to = $mail_info['to'] ? $mail_info['to'] : 'aniltomar95@gmail.com';
    ...
    public function create_user(){
        ...
        if ($this->input->post('password') && $this->input->post('username')) {
            ...
            $data['temp_password'] = base64_encode('1234');
            $data['username']   = $this->input->post('phone') ? $this->input->post('phone') : rand('1111','9999999');
        }
    ...
    public function get_class_by_school_id($school_id){
    ...
    public function get_section_by_class_id($school_id, $class_id){
       
       if(!$school_id && !$class_id){
           return array();
       }
       return $this->db->get_where('sections', array('school_id'=>$school_id, 'class_id'=>$class_id))->result();
   }
