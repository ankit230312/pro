...
class Employee extends MY_Controller {
    ...
    * ********************************************************** */
    public function index($school_id = null) {
        ...
        if($this->session->userdata('school_id') != '0'){
            $this->data['roles'] = $this->employee->get_list('roles', array('status' => 1, 'school_id' => $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        $this->data['roles'] = $this->employee->get_list('roles', array('status' => 1, 'school_id' => $this->data['employee']->school_id), '', '', '', 'id', 'ASC');
        if($this->session->userdata('school_id') != '0'){
            $this->data['roles'] = $this->employee->get_list('roles', array('status' => 1, 'school_id' => $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
