                                ...
                                <div class="row">    
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field role_idchanged" name="role_id" id="add_role_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="row"> 
                                 ...
                                 <div class="row">   
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="role_id"><?php echo $this->lang->line('role'); ?> <span class="required">*</span></label>
                                            <select  class="form-control col-md-7 col-xs-12 quick-field role_idchanged" name="role_id" id="edit_role_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($roles as $obj){ ?>
                                                    <?php if(in_array($obj->id, array(SUPER_ADMIN, GUARDIAN, STUDENT, TEACHER))){ continue;} ?>
 ...
 <script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function(){
        ...
        <?php if(isset($edit) && !empty($edit)){ ?>
            ...
            role_id =  '<?php echo $employee->role_id; ?>';
         <?php } ?> 
       ...
       $.ajax({       
            ...
            success: function(response){                                                   
               ...
               {  
                   ...
                   get_roles_by_school(school_id, role_id);
               }
            }
        });
    ...
    function get_roles_by_school(school_id, role_id){
