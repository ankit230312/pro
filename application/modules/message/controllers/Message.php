        ...
        if ($_POST) {
            ...
            if (isset($_POST['draft'])) { // if draft
                ...
                if ($this->input->post('message_id')) {
                    ...
                    foreach ($this->input->post('receiver_id') as $keyreceiver_id => $valuereceiver_id) {
                        $relation_data['receiver_id'] = $valuereceiver_id;
                ...
                foreach($this->input->post('receiver_id') as $keys=> $vls){
                   $studentsid =  $this->message->get_user($_POST['school_id'], $_POST['class_id'], $_POST['section_id'], $school->academic_year_id, $vls);
                        if($studentsid){
                                notifications($studentsid->student_id, 'student', 'in_app_messages', 'You received a message');
                        }
                }
