                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="item form-group display">                                 
                                    <select  class="form-control col-md-12 col-xs-12"  name="class_id"  id="class_id">
                                ...
                                <div class="item form-group display">                                 
                                    <select  class="form-control col-md-7 col-xs-12 quick-field" name="section_id" id="add_section_id">
                                    ...
                                    <div class="item form-group">                                 
                                        <select  class="form-control col-md-12 col-xs-12 select2" multiple="multiple"  name="receiver_id[]"  id="receiver_id" required="required" >
...
<script type="text/javascript">
  ...
  <?php if(isset($message)){ ?>
   ...
   $('#add_role_id').on('change', function(){
        var role_id = $(this).val();
        var stdatatype = $(this).find(':selected').data('type')

        if (stdatatype == 'student') {
            $('.display').show();
           $('#class_id').attr("required");
           $('#receiver_id').html('<option value="">--<?php echo $this->lang->line('receiver'); ?>--</option>'); 
        }else{
   ...
   $('#class_id').on('change', function(){
        ...
        var role_id = $('#add_role_id').find(':selected').val()
        get_user(role_id, class_id,'')
     ...
     $('#add_section_id').on('change', function(){
        var section_id = $(this).val();
        var class_id = $('#class_id').find(':selected').val()
        get_student_by_section_compose(class_id, section_id)
    ...
    function get_student_by_section_compose(class_id, section_id){       
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_student_by_section_compose'); ?>",
            data   : { school_id:school_id, class_id : class_id , section_id: section_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
