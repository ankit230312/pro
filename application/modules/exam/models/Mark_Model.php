...
class Mark_Model extends MY_Model {
    ...
    public function get_exam_result_list($school_id = null, $exam_id = null, $class_id = null, $section_id = null, $subject_id = null, $academic_year_id = null){
       ...
       $this->db->join('exam_online_exams AS OE', 'OE.id = TE.exam_id', 'left');
       ...
       $this->db->where('OE.title', $exam_id);
       $this->db->where('TE.approve_status', 1);
    ...
    public function get_exam_and_taken_detail($school_id = null, $exam_id = null, $class_id = null, $section_id = null, $subject_id = null, $academic_year_id = null){
    ...
    public function get_student_list_exam_online_exams($school_id = null, $exam_id = null, $class_id = null, $section_id = null, $subject_id = null, $academic_year_id = null){
        
        $this->db->select('ES.*, E.roll_no, E.class_id, E.section_id, C.name AS class_name, S.id AS student_id, S.name AS student_name, S.photo,  S.phone');
        $this->db->from('exam_online_exams AS ES');        
        $this->db->join('classes AS C', 'C.id = ES.class_id', 'left');
        $this->db->join('enrollments AS E', 'E.class_id = ES.class_id', 'left');        
        $this->db->join('students AS S', 'S.id = E.student_id', 'left');
