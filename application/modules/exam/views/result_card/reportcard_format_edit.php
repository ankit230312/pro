<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-home"></i><small> <?php echo $this->lang->line('result_card_update_col'); ?></small></h3>
                    ...
                    <ul class="nav nav-tabs bordered">
                        <?php if (has_permission(VIEW, 'administrator', 'school')) { ?>
                            ...
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                                        } ?>"><a href="<?php echo site_url('exam/resultcard/result_card_format_edit'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                        <?php } else { ?>
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                    ...
                    <div class="tab-content">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($schools) && !empty($schools)) { ?>
                                            <?php foreach ($schools as $obj) { ?>
                                                ...
                                                <?php
                                                $planid = '';
                                                $mainsubscriptionids = $this->db->get_where('saas_subscriptions', ['id' => $obj->subscription_id])->row();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php foreach ($subscriptions as $sp) { ?>
                                                            <?php if ($sp->id == $planid) {  ?>
                                                                <p><strong><?php echo $sp->plan_name; ?></strong></p>
                                                            <?php } ?>
                                                        <?php } ?>
                        ...
                        <div class="tab-pane fade in  <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <?php extract($edit_col); ?>
                                <?php echo form_open_multipart(site_url('exam/resultcard/result_card_format_update/').$id); ?>

                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title"><strong><?php echo $this->lang->line('result_card_update_col'); ?>:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_url"><?php echo $this->lang->line('result_card_update_col'); ?> <span class="required">*</span></label>
                                            <input class="form-control col-md-7 col-xs-12" name="ins_col_up" id="ins_col_up" value="<?php echo $result_col_name ?>" required="required" type="text" autocomplete="off">
