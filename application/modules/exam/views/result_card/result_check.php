                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><input type="radio" class="present_" name="present_" value="1" id="">&nbsp<?php echo "Yes" ?></td>
                                                            <td><input type="radio" class="present_" name="present_" value="0" id="">&nbsp<?php echo "No" ?></td>
                                                            <td>
