<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-home"></i><small> <?php echo $this->lang->line('result_card_col_ins'); ?></small></h3>
                    ...
                    <ul class="nav nav-tabs bordered">
                        <?php if (has_permission(VIEW, 'administrator', 'school')) { ?>
                            <li class="<?php if (isset($list)) {
                                        ...
                                        <!-- <a href="#tab_school_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> -->
                                     </li>
                        <?php } ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <?php echo validation_errors(); ?>
                                <?php echo form_open_multipart(site_url('exam/resultcard/result_card_col_ins1')); ?>

                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title"><strong><?php echo $this->lang->line('result_card_col_ins'); ?>:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
