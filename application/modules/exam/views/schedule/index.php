    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content quick-link">
                <?php $this->load->view('exam-schedule'); ?> 
            </div>
                                        ...
                                        <?php $count = 1; if(isset($schedules) && !empty($schedules)){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if (has_permission(EDIT, 'exam', 'schedule')) { ?>
                                                            <a href="<?php echo site_url('exam/schedule/addquestion/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('add_question'); ?> </a>
                                                        <?php } ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_schedule">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/schedule/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="maximum_marks">Maximum Marks <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="maximum_marks"  id="maximum_marks" value="<?php echo isset($post['maximum_marks']) ?  $post['maximum_marks'] : ''; ?>" placeholder="<?php echo $this->lang->line('maximum_marks'); ?>" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('maximum_marks'); ?></div>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="duration">Duration (Minute)<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="duration"  id="duration" value="<?php echo isset($post['duration']) ?  $post['duration'] : ''; ?>" placeholder="<?php echo $this->lang->line('duration'); ?>" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('duration'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="suggestion"><?php echo $this->lang->line('instruction'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="suggestion"  id="suggestion" placeholder="<?php echo $this->lang->line('instruction'); ?>"><?php echo isset($post['suggestion']) ?  $post['suggestion'] : ''; ?></textarea>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/schedule/edit/'.$schedule->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="maximum_marks"  id="maximum_marks" value="<?php echo isset($schedule->maximum_marks) ?  $schedule->maximum_marks : ''; ?>" placeholder="Maximum Marks" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('maximum_marks'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="duration"  id="duration" value="<?php echo isset($schedule->duration) ?  $schedule->duration : ''; ?>" placeholder="Duration" required="required" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('duration'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="suggestion"><?php echo $this->lang->line('suggestion'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="suggestion"  id="suggestion" placeholder="<?php echo $this->lang->line('suggestion'); ?>"><?php echo isset($schedule->suggestion) ?  $schedule->suggestion : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('suggestion'); ?></div>
                                    </div>
                                </div>
...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">
    ...
    //          data   : { school_id:school_id,exam_type_id:exam_type_id, exam_sub_type_id:exam_sub_type_id},               
    //          async  : false,
    //          success: function(response){                                                   
    //             if(response)
    //             { 
