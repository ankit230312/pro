<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <?php $this->load->view('quick-link-exam-mark'); ?> 
            </div>      
            ...
            <div class="x_content">
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $attendance = get_exam_attendance($school_id, $obj->student_id, $academic_year_id, $exam_id, $class_id, $section_id, $subject_id); ?>
                                <tr>
                                    ...
                                    <td>
                                    <input type="hidden" value="1"  name="exam_main"/>
                            ...
                            <?php } ?>
                        <?php }elseif (isset($students_online) && !empty($students_online)) {

                            
                            ?>
                            <?php foreach ($students_online as $obj) { ?>
                            <?php  $mark = get_exam_mark($school_id, $obj->student_id, $academic_year_id, $exam_id, $class_id, $section_id, $subject_id); ?>
                            <?php  $attendance = get_exam_attendance($school_id, $obj->student_id, $academic_year_id, $exam_id, $class_id, $section_id, $subject_id); 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" value="1"  name="online_exam_main" />
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-5">
                        <?php  if ((isset($students) && !empty($students) || (isset($students_online) && !empty($students_online) ))) { ?>
