                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_result">   
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            $mark_online = get_exam_total_mark_online($school_id, $exam->id, $obj->id, $academic_year_id,  $class_id, $section_id );
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> 
                                        <?php echo $mark->total_subject+$mark_online->total_subject; ?>
                                        <input type="hidden" name="total_subject[<?php echo $obj->id; ?>]" value="<?php echo $mark->total_subject+$mark_online->total_subject; ?>" />
                                    </td>
                                    <td>
                                        <?php echo $mark->exam_mark+$mark_online->exam_mark; ?>
                                        <input type="hidden" name="total_mark[<?php echo $obj->id; ?>]" value="<?php echo $mark->exam_mark+$mark_online->exam_mark; ?>" />
                                    </td>                                    
                                    <td>
                                        <?php echo $mark->obtain_mark+$mark_online->obtain_mark; ?>
                                        <input type="hidden" name="total_obtain_mark[<?php echo $obj->id; ?>]" value="<?php echo $mark->obtain_mark+$mark_online->obtain_mark; ?>" />
                                    </td>                                
                                    <td>
                                        <input class="form-control col-md-7 col-xs-12 " type="text" name="avg_grade_point[<?php echo $obj->id; ?>]" value="<?php echo $mark->total_point+$mark_online->total_point > 0 ? @number_format($mark->total_point+$mark_online->total_point/$mark->total_subject+$mark_online->total_subject,2) : ''; ?>" style="width: 60px;"  autocomplete="off"/>
                                    </td>  
                                    <td>
