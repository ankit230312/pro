        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 <?php if (!isset($final_result_type) && $final_result_type != 1) {
                                                                echo 'display';
                                                            } ?>">
                                    ...
                                    <td>
                                        <select class="form-control col-md-7 col-xs-12" name="grade_id[<?php echo $obj->id; ?>]" required="required">
                                            ...
                                            <?php foreach ($grades as $grade) { ?>
                                                <option value="<?php echo $grade->id; ?>" <?php if (isset($result) && $result->grade_id == $grade->id) {
                                                                                                echo 'selected="selected"';
                                                                                            } ?>><?php echo $grade->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                    <td><input type="text" value="<?php if (isset($result) && $result->remark != '') {
                                                                        echo $result->remark;
                                                                    } else {
                                                                        echo $remark;
                                                                    } ?>" name="remark[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12" autocomplete="off" /></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
