    ...
    //   print_r($settings);
      ...
      ?>
          <div class="col-md-12 col-sm-12 col-xs-12 invoice-header_ text-center" style="text-align: center !important;">
               ...
               <?php }else if($settings->frontend_logo){ ?>
                  <img src="<?php echo UPLOAD_PATH; ?>logo/<?php echo $settings->frontend_logo; ?>" alt="" width="100"/> 
               <?php }else{ ?>                                                        
   ...
   <section class="content invoice"> 
       ...
       <div class="row">       
           <p class="white text-center">
                ...
                <?php }else{ ?>
                   <?php echo 'Copyright © '. date('Y').' Generated By Educlouds'; ?> 
                <?php } ?>
           </p> 
       </div>
