                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/discount/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" onchange="change_discount_text(this.value)" name="discount_type" id="discount_type" required="required">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 change_discount_text" for="amount"><?php echo $this->lang->line('amount'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/discount/edit/'.$discount->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="discount_type"><?php echo $this->lang->line('discount_type'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="discount_type" id="discount_type"  onchange="change_discount_text(this.value)" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
...
<!-- datatable with buttons -->
 <script type="text/javascript">
    ...
    function change_discount_text(val) {
        if(val == 'percentage'){
            $('.change_discount_text').text('Percentage Amount')
        }else if(val == 'flat'){
            $('.change_discount_text').text('Amount')
        }
    }
