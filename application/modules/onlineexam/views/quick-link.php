...
<?php if(has_permission(VIEW, 'onlineexam', 'instruction')){ ?>
 <a class="nav-link1" class="nav-link1 active" href="<?php echo site_url('onlineexam/instruction/index'); ?>"><?php echo $this->lang->line('instruction'); ?></a>
<?php } ?>

<?php if(has_permission(VIEW, 'onlineexam', 'question')){ ?>
 <a class="nav-link1" href="<?php echo site_url('onlineexam/question/index'); ?>"><?php echo $this->lang->line('question_bank'); ?></a>
<?php } ?>
...
<?php } ?>
 ...
 <?php if(has_permission(VIEW, 'onlineexam', 'takeexam')){ ?>
  <a class="nav-link1" href="<?php echo site_url('onlineexam/takeexam/result'); ?>"><?php echo $this->lang->line('exam_result'); ?></a>
<?php } ?> </ul>
