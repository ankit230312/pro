                    ...
                    <div class="tab-content">                        
                        ...
                        <div  class="tab-pane fade in <?php if(isset($instruction)){ echo 'active'; }?>" id="tab_exam_instruction">
                            ...
                            <div class="x_content"> 
                                ...
                                <div class="row instructions">
                                    <div class="col-md-12 col-sm-12 col-xs-12 theme-color"><h3><i class="fa fa-check"></i> <?php echo $this->lang->line('exam_title'); ?>: <?php echo get_exam_detail_by_id($online_exam->title)->title; ?></h3></div>
                                    <div class="col-md-12 col-sm-12 col-xs-12 theme-color"><h3><i class="fa fa-check"></i> <?php echo $this->lang->line('instruction'); ?>:</h3> <p class="chattis"><?php echo $online_exam->instruction_id; ?></p> </div>
                                </div>                                                        
                                                         
                                <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-6 supplyyyy">
