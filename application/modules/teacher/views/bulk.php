                                ...
                                <div class="row">                                      
                                    ...
                                    <?php } ?>
                                     ...
                                     <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                             <label for="">&nbsp;</label>
                                            <a  target="_blank" href="<?php echo ASSET_URL; ?>csv/bulk_teacher.csv"  class="btn btn-success btn-md"><?php echo $this->lang->line('generate_csv'); ?></a>
                                         </div>
                                     </div> 
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="bulk_teacher"  id="bulk_teacher" required type="file">
                                            </div>
                                         </div>
                                     </div>
                                </div>
