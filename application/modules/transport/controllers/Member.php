...
class Member extends MY_Controller {
    ...
    * ********************************************************** */
     public function index() {
        ...
        if($this->session->userdata('role_id') == STUDENT){
            $this->data['members'] = $this->member->get_transport_member_list($is_transport_member = 1, $school_id, $class_id, $academic_year_id,$type);
        }else{
            $this->data['members'] = $this->member->get_transport_member_list($is_transport_member = 1, $school_id, $class_id, $academic_year_id,$type);
        ...
        $this->data['route_list'] = $this->member->get_list('routes', $condition, '','', '', 'id', 'ASC');
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['non_members'] = $this->member->get_transport_member_list($is_transport_member = 0, $school_id, $class_id, $academic_year_id, $type);
