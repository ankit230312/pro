                ...
                <div class="col-lg-10 col-6">
                    <div class="stellarnav">
                        <ul>
                            ...
                            <!-- <li><div class="add-to">
                            <button class="add-to-btn">Add</button>
                        </div></li> -->
                            ...
                            <div class="asd____color">
  
                            <?php if (logged_in_user_id()) { ?>  
                            
                                <a href="<?php echo site_url('dashboard/index'); ?>" class="link logoo"><span class="icon"><i class="fas fa-dashcube"></i></span> <?php echo $this->lang->line('dashboard'); ?></a>
                                <a href="<?php echo site_url($school->school_url.'/logout'); ?>" class="link cringe"><span class="icon"><i class="fas fa-unlock"></i></span> <?php echo $this->lang->line('logout'); ?></a>                            
                            <?php }else{ ?>  
                                <a href="<?php echo site_url($school->school_url.'/login'); ?>" class="link news_l"><span class="icon"><i class="fas fa-lock"></i></span> <?php echo $this->lang->line('login'); ?></a>
                            <?php } ?>  
