                    ...
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <?php if(isset($school->frontend_logo)){ ?>                            
                                <img src="<?php echo UPLOAD_PATH; ?>/logo/image.png" alt=""  />
                            ...
                            <?php } ?>
                            <!-- <img src="./../../../assets/images/front/image.png" alt=""> -->
                            <!-- url(./../../../assets/images/front/footer-bg.png) -->
                        </div>
                        <p class="text">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="copyright">
                ...
                <p class='makemaya'>Made By Makemaya</p>
            </div>
        </div>
    </div>
</footer>