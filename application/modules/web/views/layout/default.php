...
<html lang="en">
    <head>
        ...
        <?php 
        // echo "<pre>";
        //     print_r($school->school_name);

        ?>
        <script>
            var school_name = "<?php echo $school->school_name; ?>";
            var school_url = "<?php echo base_url().'/'.$school->school_url; ?>";
        </script>
        

       
        
        <link rel="manifest" href="<?php echo base_url(); ?>assets/home-screen/manifest.json">
...
<script type="text/javascript">
		...
		if ('serviceWorker' in navigator) {
			window.addEventListener('load', function () {
				navigator.serviceWorker.register('https://educlouds.app/sw.js').then(function (registration) {
