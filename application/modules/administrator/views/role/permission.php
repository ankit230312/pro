                            ...
                            <select class="form-control col-md-7 col-xs-12" id="filter_class_id" name="class_id" style="width:auto;" onchange="get_permission_setting_by_role(this.value)">
                                ...
                                <?php if (isset($roles) && !empty($roles)) { ?>
                                    <?php foreach ($roles as $obj) { ?>
                                        <option value="<?php echo site_url('administrator/permission/index/' . $obj->id); ?>" <?php if (isset($filter_role_id) && $filter_role_id == $obj->id) {
                                                ...
                                                foreach ($modules as $obj) { ?>
                                                    ...
                                                    <?php if (isset($operations) && !empty($operations)) { ?>
                                                        ...
                                                        foreach ($operations as $op) {
                                                            ...
                                                            if ($op->is_not_show_to_school == '1' && $this->session->userdata('role_id') != 1) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($op->is_view_vissible) { ?>
                                                                            <input type="checkbox" class="fn_view" name="is_view[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_view) && $permission->is_view == 1) {
                                                                ...
                                                                <td>
                                                                    <?php if ($op->is_add_vissible) { ?>
                                                                        <input type="checkbox" class="fn_add" name="is_add[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_add) && $permission->is_add == 1) {
                                                                                                                                                                    echo 'checked="checked"';
                                                                                                                                                                } ?> />
                                                                </td>
                                                            <?php } ?>
                                                            <td>
                                                                <?php if ($op->is_edit_vissible) { ?>
                                                                    <input type="checkbox" class="fn_edit" name="is_edit[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_edit) && $permission->is_edit == 1) {
                                                                                                                                                                echo 'checked="checked"';
                                                                                                                                                            } ?> />
                                                            </td>
                                                        <?php } ?>
                                                        <td>
                                                            <?php if ($op->is_delete_vissible) { ?>
                                                                <input type="checkbox" class="fn_delete" name="is_delete[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_delete) && $permission->is_delete == 1) {
                                                                                                                                                                echo 'checked="checked"';
                                                                                                                                                            } ?> />
                                                        </td>
                                                    <?php } ?>
