                            ...
                            <?php if (!isset($permission)) { ?>
                                <div class="tab-pane pade active" id="tab_perimission">
                                    ...
                                    <div class="x_content" style=" overflow-y: auto; overflow-y: hidden;">
                                        <?php echo form_open(site_url('administrator/permission/index/'), array('name' => 'login', 'id' => 'login', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                        ...
                                        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="2"><?php echo $this->lang->line('status'); ?>
                                                    <th colspan=""><?php echo $this->lang->line('action'); ?>
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($fetch_dd)) {
                                                    ...
                                                    foreach ($fetch_dd->result() as $row) {
                                                ?>
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>
                                                            <td><?php echo $row->result_col_name ?></td>
                                                            <td><input type="radio" class="present_" name="present_<?php echo $row->id ?>" <?php if ($row->status == 1) {
                                                                                                                                                echo "checked";
                                                                                                                                            } else {
                                                                                                                                                echo "";
                                                                                                                                            } ?> value="1" id="">&nbsp<?php echo "Yes" ?></td>
                                                            <td><input type="radio" class="present_" name="present_<?php echo $row->id ?>" value="0" <?php if ($row->status == 0) {
                                                                                                                                                            echo "checked";
                                                                                                                                                        } else {
                                                                                                                                                            echo "";
                                                                                                                                                        } ?> id="">&nbsp<?php echo "No" ?></td>
                                                            <td>
                                                ...
                                                <?php $i = 1;
                                                // print_r($fetch);
                                                if (isset($fetch_dd_selected)) {

                                                    foreach ($fetch_dd_selected->result() as $row) {
                                                ?>
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>
                                                            <td><?php echo $row->result_col_name ?></td>
