                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('administrator/school/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="item form-group">                                           
                                            <label for="school_url"><?php echo $this->lang->line('subscription'); ?> <span class="required">*</span></label>
                                            <select required  class="form-control col-md-7 col-xs-12"  name="subscription_id"  id="subscription_add" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($subscriptions as $sp){ ?>
                                                    <option value="<?php echo $sp->id; ?>"><?php echo $sp->plan_name; ?></option>
                                                <?php } ?>
                                            </select> 
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_url">School Type<span class="required">*</span></label>
                                            <select required  class="form-control col-md-7 col-xs-12"  name="result_id"  id="result_id" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
