        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $school = $this->holiday->get_school_by_id($data['school_id']);                 
                    $get_user_list =  $this->holiday->get_user_list($data['school_id'], $school->academic_year_id);

                    foreach($get_user_list as $keys=> $vls){
                        notifications($vls->student_id, 'student', 'holiday', 'Has been created a holiday : '.$data['title']);
                    }
