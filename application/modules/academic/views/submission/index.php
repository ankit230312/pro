                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(VIEW, 'academic', 'assignment')){ ?>
                            <li  class=""><a href="<?php echo site_url('academic/assignment/index'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('assignment'); ?></a> </li>   

                        <?php } ?> 

                        <!-- <?php if(has_permission(VIEW, 'academic', 'submission')){ ?>
                            <li  class=""><a href="<?php echo site_url('academic/submission/index'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('submission'); ?></a> </li>   
