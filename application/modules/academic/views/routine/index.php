            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered  no-print">
                        ...
                        <?php }?>
                        <li class="<?php if (isset($edit)) {echo 'active';}?>"><a
                                href="<?php echo site_url('academic/routine/edit'); ?>" aria-expanded="false"><i
                                    class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-sm-6 col-xs-6  col-sm-offset-3 col-xs-offset-3 layout-box">
                                ...
                                <br>
                                <a href="<?php echo base_url(); ?>academic/routine/edit/<?php echo $school->id; ?>"
