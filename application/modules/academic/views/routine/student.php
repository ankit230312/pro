...
.btn-group.studden button {
    width: 100%;
    padding: 5px !important;
}
.btn-group.new__2324ffh7 {
        ...
        <div class="x_panel">
            <div class="x_title no-print">
                <h3 class="head-title"><i class="fa fa-clock-o"></i><small>
                        <?php echo $this->lang->line('manage_routine'); ?></small></h3>
                    ...
                    <ul class="nav nav-tabs bordered  no-print">
                        ...
                        <li class="li-class-list">
                            ...
                            <select class="form-control col-md-7 col-xs-12" onchange="get_subject_by_class(this.value);">
                                ...
                                <option value="<?php echo site_url('academic/routine/index/' . $obj->id); ?>"
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-sm-6 col-xs-6  col-sm-offset-3 col-xs-offset-3 layout-box">
                                ...
                                <h4> <?php echo $this->lang->line('class'); ?> - <?php echo $single_class->name; ?></h4>
                            ...
                            <div class="x_content">
                                <div class="" data-example-id="togglable-tabs">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <?php $active = '';
                                            $other = false;
                                            $count = 0;foreach ($sections as $key => $obj) {?>
                                        <?php
                                        if ($this->session->userdata('role_id') == GUARDIAN) {
                                                if (!in_array($obj->id, $guardian_section_data)) {continue;}
                                                $active = 'active';
                                                ...
                                                ?>
                                        <div class="tab-pane fade in <?php if ($other && $key == 0) {echo 'active';} else {echo $active;}?>"
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group new__2324ffh7">
                                                            <span class="btn btn-default ">
                                                               ...
                                                               ?>
                                                                   <a class="btn btn-danger" href="<?php echo site_url('academic/routine/delete_period/' . $periodvalue->period.'/'.$periodvalue->school_id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php foreach ($routines as $rokeys => $ro) {
                                                                ...
                                                                ?>
                                                                <div class="btn-group studden">

                                                                <?php 
                                                                if ($this->session->userdata('role_id') == GUARDIAN || $this->session->userdata('role_id') == STUDENT) {
                                                            ?>
                                                            
                                                                    <button class="btn btn-default  routine-text">
                                                                    <br>
                                                                        <p><?php echo $ro->start_time . ' - ' . $ro->end_time; ?></p>
                                                                        <br>
                                                                        ...
                                                                        <?php foreach ($teachers as $keyteacher => $teacher) {?>
                                                                            ...
                                                                            <?php if ($ro->teacher_id == $teacher->id) {
                                                                                echo $teacher->name;
                                                                                }?>
                                                                        ...
                                                                        <?php if ($ro->class_type == 'offline') { ?>
                                                                            ...
                                                                            <p>Room Number - <?php echo  $ro->room_no ?></p>

                                                                            <?php  }else{ ?>
                                                                                <p><a class="btn btn-success btn-small" target="_blank" href="<?php echo  $ro->online_class_link; ?>">Join Class </a></p>
                                                                          <?php  } ?>
                                                                    </button>
                                                            <?php 
                                                                ...
                                                                ?>
                                                                    <button class="btn btn-default  routine-text">
                                                                        ...
                                                                        <select name="subject_change"
                                                                            class="common_change subject_change">
                                                                            <option value="">select subject</option>
                                                                            <?php foreach ($subjects as $keysubject => $subject) {?>
                                                                            <option data-id="<?php echo $ro->id; ?>"
                                                                                data-type="subject_id"
                                                                                <?php if ($ro->subject_id == $subject->id) {echo 'selected';}?>
                                                                                value="<?php echo $subject->id ?>">
                                                                                <?php echo $subject->name ?></option>
                                                                            <?php }?>
                                                                        </select>
                                                                        <br />
                                                                        <select name="teacher_change"
                                                                            class="common_change teacher_change">
                                                                            <option value="">select teacher</option>
                                                                            <?php foreach ($teachers as $keyteacher => $teacher) {?>
                                                                            <option data-id="<?php echo $ro->id; ?>"
                                                                                data-type="teacher_id"
                                                                                <?php if ($ro->teacher_id == $teacher->id) {echo 'selected';}?>
                                                                        ...
                                                                        <br />
                                                                                ...
                                                                                <select name="class_type"
                                                                                    class="common_change class_type">
                                                                                    <option value="">Select Class type</option>                                                                            
                                                                                    <option data-id="<?php echo $ro->id; ?>" data-type="class_type"
                                                                                        <?php if ($ro->class_type == 'offline') { echo 'selected';}?>
                                                                                        value="offline">Offline</option>

                                                                                    <option data-id="<?php echo $ro->id; ?>" data-type="class_type"
                                                                                    <?php if ($ro->class_type == 'online') {echo 'selected';}?>
                                                                                    value="online">Online</option>

                                                                                    <div class="roomselect" style=" display:
                                                                                    <?php
                                                                                    if($ro->class_type == 'offline'){ 
                                                                                        echo 'block'; 
                                                                                    }else{
                                                                                        echo 'none';
                                                                                    }
                                                                            ...
                                                                            <br>
                                                                            <div class="roomselect roomselect<?php echo $ro->id; ?>" style=" display:
                                                                                        <?php
                                                                                        if($ro->class_type == 'offline'){ 
                                                                                            echo 'block'; 
                                                                                        }else{
                                                                                ...
                                                                                <!-- <br> -->
                                                                                <input type="text" class="common_change common_changeroom_change" value="<?php echo $ro->room_no; ?>" name="" id=""  data-id="<?php echo $ro->id; ?>"
                                                                                data-type="room_no">
                                                                                <!-- <select name="room_change"
                                                                                    class="common_change room_change">
                                                                                    <option value="">Select Room</option>
                                                                                    <?php foreach ($rooms as $keyroom => $room) {?>
                                                                                    <option data-id="<?php echo $ro->id; ?>"
                                                                                        data-type="room_no"
                                                                                        <?php if ($ro->room_no == $room->id) {echo 'selected';}?>
                                                                                        value="<?php echo $room->id ?>">
                                                                                        <?php echo $room->room_no ?></option>
                                                                                        <?php }?>
                                                                                </select> -->
                                                                                            ...
                                                                                            <br>
                                                                                <div class="linkselect linkselect<?php echo $ro->id; ?>" style=" display:
                                                                                        <?php
                                                                                        if($ro->class_type == 'online'){ 
                                                                                            echo 'block'; 
                                                                                        }else{
                                                                                            echo 'none';
                                                                                        }
                                                                                        ?>">
                                                                                            <?php echo 'Online Class Link'; ?>

                                                                                           <p> <input data-id="<?php echo $ro->id; ?>"
                                                                                        data-type="online_class_link" type="text" name="online_class_link"
                                                                                                class="common_change_input online_class_link_change" value="<?php echo  $ro->online_class_link; ?>"></p>
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group ">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                        for="name_duration"><?php echo 'Duration Name'; ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="name_duration"
                                            ...
                                            placeholder="<?php echo $this->lang->line('name_duration'); ?>"
                                             type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('name_duration'); ?></div>
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group ">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="name_duration"
                                            id="name_duration"
                                            value="<?php echo $periods[0]->name_duration; ?>"
                                            placeholder="<?php echo $this->lang->line('name_duration'); ?>"
                                             type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('name_duration'); ?></div>
                                    </div>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <?php foreach ($periods as $key => $value) { ?>
                                        ...
                                        <div>
                                            <div class="item form-group ">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                    for="period"><?php echo 'Period'; ?> <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12 period"
                                                        name="period[]" id="period" value="<?php echo $value->period; ?>"
                                            ...
                                            <div class="item form-group">
                                                <label
                                                    class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line('start_time'); ?>
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12 add_start_time"
                                                        name="start_time[]" id="add_start_time" value="<?php echo $value->start_time; ?>"
                                                        placeholder="<?php echo $this->lang->line('start_time'); ?>"
                                                        required="required" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('start_time'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                <label
                                                    class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line('end_time'); ?>
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12 add_end_time"
                                                        name="end_time[]" id="add_end_time" value="<?php echo $value->end_time; ?>"
