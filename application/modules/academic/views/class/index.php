                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/classes/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 fn_group_id"  name="group_id"  id="add_group_id" required="required" >
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="level_id"><?php echo $this->lang->line('level'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="level_id"  id="add_level_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($levels as $obj ){ ?>
                                            <option value="<?php echo $obj->id; ?>" <?php echo isset($post['level_id']) && $post['level_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>                                            
                                        </select>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/classes/edit/'.$class->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 fn_group_id"  name="group_id"  id="edit_group_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($groups as $obj ){ ?>
                                            <option value="<?php echo $obj->id; ?>" <?php echo isset($post['group_id']) && $post['group_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>                                            
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="level_id"  id="edit_level_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($levels as $obj ){ ?>
                                            <option value="<?php echo $obj->id; ?>" <?php echo isset($post['level_id']) && $post['level_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>                                            
...
<!-- Super admin js START  -->
 <script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function(){
        ...
        var group_id = '';
        <?php if(isset($class) && !empty($class)){ ?>         
            group_id =  '<?php echo $class->group_id; ?>';
         <?php } ?> 
    ...
    $('.fn_group_id').on('change', function(){
      
        var group_id = $(this).val();       
        var level_id = '';
        <?php if(isset($class) && !empty($class)){ ?>         
            level_id =  '<?php echo $class->level_id; ?>';
            group_id =  '<?php echo $class->group_id; ?>';
         <?php } ?> 
        
        if(!group_id){

           toastr.error('<?php echo $this->lang->line("select_group"); ?>');
           return false;
        }
        
         $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_level_by_group'); ?>",
            ...
            success: function(response){                                                   
               ...
               {    
                   if(level_id){
                       $('#edit_level_id').html(response);
                   }else{
                       $('#add_level_id').html(response); 
                   }
               }
            }
        });       
