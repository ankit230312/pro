        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $get_user_list =  $this->assignment->get_user_list($data['school_id'], $data['class_id'], $data['section_id'], $school->academic_year_id);
                    foreach($get_user_list as $keys=> $vls){
                        notifications($vls->student_id, 'student', 'assignment', 'Has been created an assignment');
                    }
