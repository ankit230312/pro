...
class Classes extends MY_Controller {
    ...
    public function index($school_id = null) {
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN){            
            ...
            $this->data['groups'] = $this->classes->get_list('groups', $condition, '','', '', 'id', 'ASC');
            $this->data['levels'] = $this->classes->get_list('levels', $condition, '','', '', 'id', 'ASC');
        }   
    ...
    private function _prepare_class_validation() {
        ...
        $this->form_validation->set_rules('level_id', $this->lang->line('level'), 'trim|required');   
