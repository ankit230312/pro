                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-12 col-sm-12 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                <input  class="form-control col-md-7 col-xs-12"  name="other_documents[]"  multiple id="add_other_documents" type="file">
                                            </div>
                                            <div class="text-info"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                            <div class="help-block"><?php echo form_error('other_documents'); ?></div>
                                         </div>
                                     </div>                                   
                                </div>
...
<!-- Super admin js START  -->
 <script type="text/javascript">
       ...
       $.ajax({       
            ...
            success: function(response){                                                   
               ...
               {  
                   ...
                   get_single_role_id_by_type(school_id, 'student')
               }
            }
        });
    }); 
    ...
    function get_single_role_id_by_type(school_id, type){
    
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_single_role_id_by_type'); ?>",
            data   : { school_id:school_id, type: type},               
            async  : false,
            success: function(response){                                                   
            if(response)
            { 
                $('#role_id').val(response);
        ...
        function check_guardian_type(guardian_type){
           ...
           if(guardian_type == 'father'){
               ...
               $('#add_relation_with').val('<?php echo $this->lang->line('father'); ?>'); 
                $('#add_gud_name').val($('#add_father_name').val());  
                $('#add_gud_phone').val($('#add_father_phone').val());  
                $('#add_gud_profession').val($('#add_father_profession').val()); 
               ...
               $('#add_relation_with').val('<?php echo $this->lang->line('mother'); ?>');   
                ...
                $('#add_gud_name').val($('#add_mother_name').val());  
                $('#add_gud_phone').val($('#add_mother_phone').val());  
                $('#add_gud_profession').val($('#add_mother_profession').val()); 
