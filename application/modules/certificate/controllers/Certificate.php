...
class Certificate extends MY_Controller {
   ...
   public function __construct() {
    ...
    public function multiple_generate(){
        ...
        if (isset($_GET)) {
            ...
            if (isset($_GET['certificate'])) {
                ...
                $certificateex  = explode(',', $certificate);

                $this->data['certificateex'] = $certificateex;            

            
                $this->layout->title($this->lang->line('generate_certificate') .' | ' . SMS);
                $this->load->view('certificate/generate_multiple', $this->data); 
            }else{
                redirect('certificate/index');
            }
