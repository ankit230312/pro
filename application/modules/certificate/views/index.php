                ...
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">                 
                        ...
                        <?php if(has_permission(VIEW, 'certificate', 'certificate')){ ?>
                            <button  class="btn btn-success btn-xs generatecertificate"><i class="fa fa-certificate"> <?php echo $this->lang->line('generate'); ?> <?php echo $this->lang->line('certificate'); ?></i></button>
                        <?php } ?>
                                ...
                                <tbody id="fn_mark">   
                                    ...
                                    if (isset($students) && !empty($students)) {
                                        ...
                                        <?php foreach ($students as $obj) { ?>
                                            ...
                                            <tr>
                                                <td><input type="checkbox" class="selectRow" value="<?php echo $obj->school_id.'_'.$obj->id.'_'.$class_id .'_'.$certificate_id; ?>"></td>
...
<!-- Super admin js START  -->
 <script type="text/javascript">
    ...
    var checkboxes = document.querySelectorAll(".selectRow");
        ...
        var values = $(".selectRow:checked").map(function(){
                return $(this).val();
            }).get();
            console.log(values);
    });
    ...
    $('.generatecertificate').on('click', function(){
        ...
        var values = $(".selectRow:checked").map(function(){
            ...
            if (values.length > 0) {
              var allval =   values.toString();  

              window.open(
                "<?php echo site_url('certificate/multiple_generate'); ?>?certificate="+allval+"",
