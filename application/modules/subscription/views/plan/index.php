                               ...
                               <div class="row">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="plan_name"  id="add_plan_name" value="<?php echo isset($post) ?  $post['plan_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('plan_name'); ?>" required="required" type="text">
                                        ...
                                        <div class="col-md-6">
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
            
                                                        <div class="demand">
                                                        <label for="">Yes</label>
                                                        <input  required="required" <?php if(isset($post['is_enable_frontend']) && $post['is_enable_frontend'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_frontend" value="1">
                                                        </div>
                                                       <div class="demand">
                                                       <label for="">No</label> 
                                                        <input  required="required" <?php if(isset($post['is_enable_frontend']) && $post['is_enable_frontend'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_frontend" value="0">
                                                       </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($post['is_enable_theme']) && $post['is_enable_theme'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_theme" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($post['is_enable_theme']) && $post['is_enable_theme'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_theme" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($post['is_enable_language']) && $post['is_enable_language'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_language" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($post['is_enable_language']) && $post['is_enable_language'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_language" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($post['is_enable_report']) && $post['is_enable_report'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_report" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($post['is_enable_report']) && $post['is_enable_report'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_report" value="0">
                                                           </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="demand_ultra">
                                                        ...
                                                        <div class="demand">
                                                        <label for="">Yes</label>
                                                        <input  required="required" <?php if(isset($post['is_enable_inventory']) && $post['is_enable_inventory'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_inventory" value="1">
                                                        </div>
                                                       <div class="demand">
                                                       <label for="">No</label> 
                                                        <input  required="required" <?php if(isset($post['is_enable_inventory']) && $post['is_enable_inventory'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_inventory" value="0">
                                                       </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="demand_ultra">
                                                        ...
                                                        <div class="demand">
                                                        <label for="">Yes</label>
                                                        <input  required="required" <?php if(isset($post['is_enable_lesson_plan']) && $post['is_enable_lesson_plan'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_lesson_plan" value="1">
                                                        </div>
                                                       <div class="demand">
                                                       <label for="">No</label> 
                                                        <input  required="required" <?php if(isset($post['is_enable_lesson_plan']) && $post['is_enable_lesson_plan'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_lesson_plan" value="0">
                                                       </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="demand_ultra">
                                                ...
                                                <div class="demand">
                                                <label for="">Yes</label>
                                                <input  required="required" <?php if(isset($post['is_enable_online_exam']) && $post['is_enable_online_exam'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_online_exam" value="1">
                                                </div>
                                               <div class="demand">
                                               <label for="">No</label> 
                                                <input  required="required" <?php if(isset($post['is_enable_online_exam']) && $post['is_enable_online_exam'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_online_exam" value="0">
                                               </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="demand_ultra">
                                                ...
                                                <div class="demand">
                                                <label for="">Yes</label>
                                                <input  required="required" <?php if(isset($post['is_enable_live_class']) && $post['is_enable_live_class'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_live_class" value="1">
                                                </div>
                                               <div class="demand">
                                               <label for="">No</label> 
                                                <input  required="required" <?php if(isset($post['is_enable_live_class']) && $post['is_enable_live_class'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_live_class" value="0">
                                               </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="demand_ultra">
                                                ...
                                                <div class="demand">
                                                <label for="">Yes</label>
                                                <input  required="required" <?php if(isset($post['is_enable_payment_gateway']) && $post['is_enable_payment_gateway'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_payment_gateway" value="1">
                                                </div>
                                               <div class="demand">
                                               <label for="">No</label> 
                                                <input  required="required" <?php if(isset($post['is_enable_payment_gateway']) && $post['is_enable_payment_gateway'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_payment_gateway" value="0">
                                               </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="demand_ultra">
                                                ...
                                                <div class="demand">
                                                <label for="">Yes</label>
                                                <input  required="required" <?php if(isset($post['is_enable_sms_gateway']) && $post['is_enable_sms_gateway'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_sms_gateway" value="1">
                                                </div>
                                               <div class="demand">
                                               <label for="">No</label> 
                                                <input  required="required" <?php if(isset($post['is_enable_sms_gateway']) && $post['is_enable_sms_gateway'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_sms_gateway" value="0">
                                               </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="demand_ultra">
                                                    ...
                                                    <div class="demand">
                                                    <label for="">Yes</label>
                                                    <input  required="required" <?php if(isset($post['is_enable_attendance']) && $post['is_enable_attendance'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_attendance" value="1">
                                                    </div>
                                                   <div class="demand">
                                                   <label for="">No</label> 
                                                    <input  required="required" <?php if(isset($post['is_enable_attendance']) && $post['is_enable_attendance'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_attendance" value="0">
                                                   </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="demand_ultra">
                                                    ...
                                                    <div class="demand">
                                                    <label for="">Yes</label>
                                                    <input  required="required" <?php if(isset($post['is_enable_exam_mark']) && $post['is_enable_exam_mark'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_exam_mark" value="1">
                                                    </div>
                                                   <div class="demand">
                                                   <label for="">No</label> 
                                                    <input  required="required" <?php if(isset($post['is_enable_exam_mark']) && $post['is_enable_exam_mark'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_exam_mark" value="0">
                                                   </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="demand_ultra">
                                                    ...
                                                    <div class="demand">
                                                    <label for="">Yes</label>
                                                    <input  required="required" <?php if(isset($post['is_enable_accounting']) && $post['is_enable_accounting'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_accounting" value="1">
                                                    </div>
                                                   <div class="demand">
                                                   <label for="">No</label> 
                                                    <input  required="required" <?php if(isset($post['is_enable_accounting']) && $post['is_enable_accounting'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_accounting" value="0">
                                                   </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="demand_ultra">
                                                    ...
                                                    <div class="demand">
                                                    <label for="">Yes</label>
                                                    <input  required="required" <?php if(isset($post['is_enable_payroll']) && $post['is_enable_payroll'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_payroll" value="1">
                                                    </div>
                                                   <div class="demand">
                                                   <label for="">No</label> 
                                                    <input  required="required" <?php if(isset($post['is_enable_payroll']) && $post['is_enable_payroll'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_payroll" value="0">
                                                   </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="demand_ultra">
                                                ...
                                                <div class="demand">
                                                <label for="">Yes</label>
                                                <input  required="required" <?php if(isset($post['is_enable_asset_management']) && $post['is_enable_asset_management'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_asset_management" value="1">
                                                </div>
                                               <div class="demand">
                                               <label for="">No</label> 
                                                <input  required="required" <?php if(isset($post['is_enable_asset_management']) && $post['is_enable_asset_management'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_asset_management" value="0">
                                               </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="demand_ultra">
                                                ...
                                                <div class="demand">
                                                <label for="">Yes</label>
                                                <input  required="required" <?php if(isset($post['is_enable_promotion']) && $post['is_enable_promotion'] == '1'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_promotion" value="1">
                                                </div>
                                               <div class="demand">
                                               <label for="">No</label> 
                                                <input  required="required" <?php if(isset($post['is_enable_promotion']) && $post['is_enable_promotion'] == '0'){ echo 'selected="selected"'; } ?> type="radio" name="is_enable_promotion" value="0">
                                               </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plan_name"><?php echo $this->lang->line('plan_name'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  class="form-control col-md-7 col-xs-12"  name="plan_name"  id="add_plan_name" value="<?php echo isset($plan) ?  $plan->plan_name : ''; ?>" placeholder="<?php echo $this->lang->line('plan_name'); ?>" required="required" type="text">
                                                <div class="help-block"><?php echo form_error('plan_name'); ?></div>
                                            </div>
                                        </div>  
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="demand_ultra">
                                                                ...
                                                                <div class="demand">
                                                                <label for="">Yes</label>
                                                                <input  required="required" <?php if(isset($plan->is_enable_frontend) && $plan->is_enable_frontend == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_frontend" value="1">
                                                                </div>
                                                               <div class="demand">
                                                               <label for="">No</label> 
                                                                <input  required="required" <?php if(isset($plan->is_enable_frontend) && $plan->is_enable_frontend == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_frontend" value="0">
                                                               </div>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="demand_ultra">
                                                                ...
                                                                <div class="demand">
                                                                <label for="">Yes</label>
                                                                <input  required="required" <?php if(isset($plan->is_enable_theme) && $plan->is_enable_theme == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_theme" value="1">
                                                                </div>
                                                               <div class="demand">
                                                               <label for="">No</label> 
                                                                <input  required="required" <?php if(isset($plan->is_enable_theme) && $plan->is_enable_theme == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_theme" value="0">
                                                               </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_language) && $plan->is_enable_language == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_language" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_language) && $plan->is_enable_language == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_language" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_report) && $plan->is_enable_report == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_report" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_report) && $plan->is_enable_report == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_report" value="0">
                                                           </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="demand_ultra">
                                                        ...
                                                        <div class="demand">
                                                        <label for="">Yes</label>
                                                        <input  required="required" <?php if(isset($plan->is_enable_inventory) && $plan->is_enable_inventory == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_inventory" value="1">
                                                        </div>
                                                       <div class="demand">
                                                       <label for="">No</label> 
                                                        <input  required="required" <?php if(isset($plan->is_enable_inventory) && $plan->is_enable_inventory == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_inventory" value="0">
                                                       </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="demand_ultra">
                                                        ...
                                                        <div class="demand">
                                                        <label for="">Yes</label>
                                                        <input  required="required" <?php if(isset($plan->is_enable_lesson_plan) && $plan->is_enable_lesson_plan == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_lesson_plan" value="1">
                                                        </div>
                                                       <div class="demand">
                                                       <label for="">No</label> 
                                                        <input  required="required" <?php if(isset($plan->is_enable_lesson_plan) && $plan->is_enable_lesson_plan == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_lesson_plan" value="0">
                                                       </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_online_exam) && $plan->is_enable_online_exam == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_online_exam" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_online_exam) && $plan->is_enable_online_exam == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_online_exam" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_live_class) && $plan->is_enable_live_class == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_live_class" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_live_class) && $plan->is_enable_live_class == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_live_class" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_payment_gateway) && $plan->is_enable_payment_gateway == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_payment_gateway" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_payment_gateway) && $plan->is_enable_payment_gateway == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_payment_gateway" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_sms_gateway) && $plan->is_enable_sms_gateway == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_sms_gateway" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_sms_gateway) && $plan->is_enable_sms_gateway == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_sms_gateway" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_attendance) && $plan->is_enable_attendance == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_attendance" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_attendance) && $plan->is_enable_attendance == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_attendance" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_exam_mark) && $plan->is_enable_exam_mark == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_exam_mark" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_exam_mark) && $plan->is_enable_exam_mark == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_exam_mark" value="0">
                                                           </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="demand_ultra">
                                                        ...
                                                        <div class="demand">
                                                        <label for="">Yes</label>
                                                        <input  required="required" <?php if(isset($plan->is_enable_accounting) && $plan->is_enable_accounting == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_accounting" value="1">
                                                        </div>
                                                       <div class="demand">
                                                       <label for="">No</label> 
                                                        <input  required="required" <?php if(isset($plan->is_enable_accounting) && $plan->is_enable_accounting == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_accounting" value="0">
                                                       </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="demand_ultra">
                                                        ...
                                                        <div class="demand">
                                                        <label for="">Yes</label>
                                                        <input  required="required" <?php if(isset($plan->is_enable_payroll) && $plan->is_enable_payroll == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_payroll" value="1">
                                                        </div>
                                                       <div class="demand">
                                                       <label for="">No</label> 
                                                        <input  required="required" <?php if(isset($plan->is_enable_payroll) && $plan->is_enable_payroll == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_payroll" value="0">
                                                       </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_asset_management) && $plan->is_enable_asset_management == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_asset_management" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_asset_management) && $plan->is_enable_asset_management == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_asset_management" value="0">
                                                           </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="demand_ultra">
                                                            ...
                                                            <div class="demand">
                                                            <label for="">Yes</label>
                                                            <input  required="required" <?php if(isset($plan->is_enable_promotion) && $plan->is_enable_promotion == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="is_enable_promotion" value="1">
                                                            </div>
                                                           <div class="demand">
                                                           <label for="">No</label> 
                                                            <input  required="required" <?php if(isset($plan->is_enable_promotion) && $plan->is_enable_promotion == '0'){ echo 'checked="checked"'; } ?> type="radio" name="is_enable_promotion" value="0">
                                                           </div>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="demand_ultra">
                                                                ...
                                                                <div class="demand">
                                                                <label for="">Yes</label>
                                                                <input  required="required" <?php if(isset($plan->status) && $plan->status == '1'){ echo 'checked="checked"'; }  ?> type="radio" name="status" value="1">
                                                                </div>
                                                               <div class="demand">
                                                               <label for="">No</label> 
                                                                <input  required="required" <?php if(isset($plan->status) && $plan->status == '0'){ echo 'checked="checked"'; } ?> type="radio" name="status" value="0">
                                                               </div>
